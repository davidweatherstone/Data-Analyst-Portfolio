...
### Power BI
* **Human Resources dashboard**, a sample dashboard designed to showcase my skills in using Power BI. The dashboard was created for a fictitious company's Human Resources department and tracks key metrics such as employee demographics and staff turnover. The visualizations are designed with a professional environment in mind, featuring a clean layout and the use of bookmarks and buttons. [[Documentation]](Projects/Power%20BI%20-%20Human%20Resources%20dashboard/README.md) [[NovyPro dashboard link]](https://www.novypro.com/project/pimhrdashboard)
