...
### Power BI
* **Procurement dashboard**, I developed a dashboard for a fictitious company that provides a comprehensive view of the organization's spend and supplier base. The dashboard allows users to easily filter data over time by department, line of business, and budget, enabling them to gain valuable insights into the company's spend and supplier relationships and allows for real-time monitoring and tracking of the organization's financial metrics. [[Documentation]](Projects/Power%20BI%20-%20Procurement%20dashboard/README.md) [[.pdf view of dashboard]](https://drive.google.com/file/d/1wqWB2MlV0036dCzYLsSd91TxyCoXMSWj/view?usp=sharing)
